...
const termsandconditions = () => {
  return (
    <>
      <Layout>
        <CategoryHero heading="Terms and Conditions" />
        <ContainerWrraper customClass={styles.GuidlinesContainerWrraper}>
          <p>
            Last updated: December 20, 2022 <br />
          ...
          <h1 className={styles.guidlineTitle}>Interpretation</h1>
          <p>
          ...
          <h1 className={styles.guidlineTitle}>Definitions</h1>
          ...
          <p>
            ...
            "Our" in this Agreement) refers to UNmedia Buzz, C/906, Ganesh
            Meridian, Opp. Kargil Petrol Pump, Sola, Ahmedabad 300060.
          </p>
          <p>
          ...
          <p>
            ...
            of the Service. This Terms and Conditions agreement has been created
            with the help of the TermsFeed Terms and Conditions Generator.
          </p>
          <p>
          ...
          <p>
            <b>Website </b>
            refers to UNmedia Buzz, accessible from https://unmediabuzz.com/
          </p>
          <p>
            <b>You </b>
          ...
          <h1 className={styles.guidlineTitle}>Severability</h1>
          <p>
          ...
          <h1 className={styles.guidlineTitle}>Waiver</h1>
          <p>
          ...
          <h1 className={styles.termTitle}>
            ...
            >
              By email: contact@UNmediaBuzz.com
            </a>
          </h1>
        </ContainerWrraper>
        <GettingStarted />
