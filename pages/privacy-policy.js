...
const privacypolicy = () => {
  return (
    <>
      <Layout>
        <CategoryHero heading="Privacy Policy for UNmedia Buzzs" />
        <ContainerWrraper customClass={styles.GuidlinesContainerWrraper}>
          <p>
            At UNmedia Buzz, accessible from https://unmediabuzz.com/, one of
            our main priorities is the privacy of our visitors. This Privacy
            Policy document contains types of information that is collected and
            recorded by UNmedia Buzz and how we use it
          </p>
          <p>
          ...
          <p>
            UNmedia Buzz follows a standard procedure of using log files. These
          ...
          <p>
            Like any other website, UNmedia Buzz uses 'cookies'. These cookies
          ...
          <p>
            ...
            advertising partners of UNmedia Buzz.
          </p>
          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on UNmedia Buzz,
          ...
          <p>
            Note that UNmedia Buzz has no access to or control over these
          ...
          <p>
            UNmedia Buzz's Privacy Policy does not apply to other advertisers or
          ...
          <h2 className={styles.italicTitlePrivacy}>
          ...
          <h1 className={styles.guidlineTitle}>GDPR Data Protection Rights</h1>
          <h2 className={styles.italicTitle}>
          ...
          <h1 className={styles.guidlineTitle}>Children's Information</h1>
          <p>
          ...
          <p>
            UNmedia Buzz does not knowingly collect any Personal Identifiable
